...
Console.Write(teststr.StartsWith("the"));
Console.Write(teststr.StartsWith("the", StringComparison.CurrentCultureIgnoreCase));

Console.Write(teststr.EndsWith("dog"));
Console.Write(teststr.EndsWith("dog", StringComparison.CurrentCultureIgnoreCase));
