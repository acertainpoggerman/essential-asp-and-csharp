...
int[] sales = {100_000, 150_000, 200_000, 225_000};
...
Console.WriteLine($"{sales[0], {}:C0} {sales[1], 12:C0} {sales[2], 12:C0} {sales[3], 12:C0}");
Console.WriteLine("International Sales:");
Console.WriteLine($"{intlMixPct[0], 12:P0} {intlMixPct[1], 12:P1} {intlMixPct[2], 12:P2} {intlMixPct[3], 12:P3}");
